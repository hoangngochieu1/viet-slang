...
for link in movie_links:
    ...
    for episode in range(1, 10):  # Có thể thay đổi số tập tùy phim
    ...
    with open("engcrawfull.txt", "a", encoding="utf-8") as f_eng, open("viecrawfull.txt", "a", encoding="utf-8") as f_vie:
